...
$\begin{align}
\textbf{a.} \hspace{1em} \frac{1}{{\sqrt 3 }} &= \frac{1}{{\sqrt 3 }} \times \frac{{\sqrt 3 }}{{\sqrt 3 }}\\
 &= \frac{{\sqrt 3 }}{3}
\end{align}$	

$\begin{align}
\textbf{b.} \hspace{1em} \frac{1}{{\sqrt 2  + 1}} &= \frac{1}{{\sqrt 2  + 1}} \times \frac{{\sqrt 2  - 1}}{{\sqrt 2  - 1}}\\
...
$\begin{align}
\textbf{c.} \hspace{1em} \frac{{2 + \sqrt 3 }}{{1 - \sqrt 3 }} &= \frac{{2 + \sqrt 3 }}{{1 - \sqrt 3 }} \times \frac{{1 + \sqrt 3 }}{{1 + \sqrt 3 }}\\
 &= \frac{{(2 + \sqrt 3 )(1 + \sqrt 3 )}}{{(1 - \sqrt 3 )(1 + \sqrt 3 )}}\\
 &= \frac{{2 + 2\sqrt 3  + \sqrt 3  + 3}}{{1 - 3}}\\
 &=  - {\textstyle{1 \over 2}}(5 + 3\sqrt 3 )
\end{align}$
